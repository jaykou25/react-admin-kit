...
var _excluded = ["columns", "onFinish", "onCancel", "formProps", "bodyStyle", "open"],
...
var ModalForm = /*#__PURE__*/function (_Component) {
  ...
  function ModalForm(props) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 5;
                return _this.props.onOpen(_this.formRef);
    ...
    _defineProperty(_assertThisInitialized(_this), "openModal", function (initialData) {
      _this.setState({
        visible: true,
