var _excluded = ["columns", "onFinish", "onCancel", "formProps", "bodyStyle", "innerRef", "open"],
  _excluded2 = ["isKeyPressSubmit", "autoFocusFirstInput", "initialValues"];
...
var ModalForm = /*#__PURE__*/function (_Component) {
  ...
  function ModalForm(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "componentDidUpdate", /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(prevProps, prevState) {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return _this.props.onOpen(_this.state.formType, _this.formRef, _this.state.formData);
            case 5:
              _this.setState({
                loading: false
              });
            case 6:
              if (!(!prevState.visible && _this.state.visible)) {
                _context.next = 12;
                break;
              }
              if (!_this.props.onOpen) {
    ...
    _defineProperty(_assertThisInitialized(_this), "openModal", function () {
      ...
      _this.setState({
        visible: true,
        formType: formType,
        formData: ((_this$props$formProps = _this.props.formProps) === null || _this$props$formProps === void 0 ? void 0 : _this$props$formProps.initialValues) || {}
      });
    });
    _defineProperty(_assertThisInitialized(_this), "onOk", function () {
      if (_this.formRef.current) {
        var submit = _this.formRef.current.submit;
        submit();
      }
    });
    _defineProperty(_assertThisInitialized(_this), "onFinish", /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(values) {
        var onFinish, _this$state, formType, formData;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              onFinish = _this.props.onFinish;
              _this$state = _this.state, formType = _this$state.formType, formData = _this$state.formData;
              _this.setState({
                loading: true
              });
              if (!onFinish) {
              ...
              _context2.prev = 4;
              _context2.next = 7;
              return onFinish(values, formType, formData);
            case 7:
              _this.setState({
                loading: false
              });
            ...
            case 11:
              ...
              console.log('onFinishError', _context2.t0);
              _this.setState({
                loading: false
              });
            case 15:
    ...
    _defineProperty(_assertThisInitialized(_this), "handleOnCancel", function () {
      ...
      var _this$props = _this.props,
        ...
        _this$props$confirmOn = _this$props.confirmOnClose,
        confirmOnClose = _this$props$confirmOn === void 0 ? true : _this$props$confirmOn;
      var isTouched = (_this$formRef$current = _this.formRef.current) === null || _this$formRef$current === void 0 ? void 0 : _this$formRef$current.isFieldsTouched();
    ...
    _defineProperty(_assertThisInitialized(_this), "getOnCancel", function () {
    ...
    _this.state = {
      visible: false,
      formData: ((_props$formProps = props.formProps) === null || _props$formProps === void 0 ? void 0 : _props$formProps.initialValues) || {},
      formType: 'new',
      loading: false
    };
    if (props.innerRef) {
  ...
  _createClass(ModalForm, [{
    ...
    value: function render() {
      var _this$props3 = this.props,
        ...
        _this$props3$bodyStyl = _this$props3.bodyStyle,
        bodyStyle = _this$props3$bodyStyl === void 0 ? {} : _this$props3$bodyStyl,
        innerRef = _this$props3.innerRef,
        open = _this$props3.open,
        rest = _objectWithoutProperties(_this$props3, _excluded);
      var _ref3 = formProps || {},
        _ref3$isKeyPressSubmi = _ref3.isKeyPressSubmit,
        isKeyPressSubmit = _ref3$isKeyPressSubmi === void 0 ? true : _ref3$isKeyPressSubmi,
        _ref3$autoFocusFirstI = _ref3.autoFocusFirstInput,
      ...
      var $innerRef = innerRef; // 只是为了类型定义, 传入SchemaForm的innerRef与ModalForm的innerRef定义不同
      var formRest = _objectSpread(_objectSpread({}, settingFormProps), {}, {
        innerRef: $innerRef
      }, restFormProps);
      ...
      return /*#__PURE__*/_jsx(Modal, _objectSpread(_objectSpread({
        ...
        children: /*#__PURE__*/_jsx(SchemaForm, _objectSpread({
          ...
          initialValues: open ? initialValues : _objectSpread({}, this.state.formData)
        }, formRest))
      }));
    }
  }]);
