var _excluded = ["rowKey", "name", "columns", "options", "pagination", "formColumns", "scroll", "onFinish", "tableAlertOption", "rowSelection", "sticky", "className", "optionColSpaceSize", "noPadding", "search", "request", "onOpen", "modalProps", "formProps"],
...
var ProTable = /*#__PURE__*/function (_Component) {
  ...
  function ProTable(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "modalFormRef", void 0);
    ...
    // 给ref上赋值
    _defineProperty(_assertThisInitialized(_this), "setData", function (newValue) {
      var _this$props$innerRef;
      if ((_this$props$innerRef = _this.props.innerRef) !== null && _this$props$innerRef !== void 0 && _this$props$innerRef.current) {
        var values = _this.props.innerRef.current.data;
        _this.props.innerRef.current.data = _objectSpread(_objectSpread({}, values), newValue);
      }
    });
    _defineProperty(_assertThisInitialized(_this), "openModal", function () {
      var _this$modalFormRef$cu;
      ...
      (_this$modalFormRef$cu = _this.modalFormRef.current) === null || _this$modalFormRef$cu === void 0 ? void 0 : _this$modalFormRef$cu.openModal(type, initialData);
    });
    _defineProperty(_assertThisInitialized(_this), "patchColumn", function ($cols) {
      var _this$props$innerRef2 = _this.props.innerRef,
        innerRef = _this$props$innerRef2 === void 0 ? _this.selfInnerRef : _this$props$innerRef2;
    ...
    _defineProperty(_assertThisInitialized(_this), "tableAlertOptionRender", function (_ref) {
      ...
      var _tableAlertOption$hid = tableAlertOption.hideDelete,
        ...
        _tableAlertOption$ena = tableAlertOption.enableExport,
        enableExport = _tableAlertOption$ena === void 0 ? false : _tableAlertOption$ena,
    ...
    _this.targetId = '';
    _this.modalFormRef = /*#__PURE__*/createRef();
    ...
    if (props.innerRef) {
      ...
      props.innerRef.current.setData = _this.setData;
    }
    return _this;
  }
          ...
          request: request ? function (params, sort, filter) {
            return new Promise(function (resolve, reject) {
              request(handleRequestParams(params, sort), sort, filter).then(function (res) {
                var _this2$props$innerRef;
                if ((_this2$props$innerRef = _this2.props.innerRef) !== null && _this2$props$innerRef !== void 0 && _this2$props$innerRef.current) {
                  _this2.props.innerRef.current.total = res.total;
                  _this2.props.innerRef.current.dataSource = res.data;
                  _this2.props.innerRef.current.params = handleRequestParams(params, sort);
                }
                resolve(res);
              }).catch(function (err) {
                return reject(err);
