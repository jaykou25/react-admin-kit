...
These are SchemaForm's fundamental concepts - you're now ready to create basic forms ✨.
...
> 👉 Important note: In embed mode, the `valueBaseName` implementation simply converts the schema's dataIndex into an array format. See this Ant Design [example](https://ant.design/components/form/#components-form-demo-nest-messages).
>
...
<Previewer title='Group Grid Layout' src="@@/SchemaForm/demos/groupGrid-en/index.tsx" />

<Previewer title='Horizontal Group Grid Layout' src="@@/SchemaForm/demos/groupGridHorizontal-en/index.tsx" />
