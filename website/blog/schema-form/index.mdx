...
更多属性请参考 [ProForm](https://procomponents.ant.design/components/form#proform) 以及 [Antd Form](https://ant.design/components/form-cn/#api), 以下列取一些常用的:
...
| dataIndex | 可使用约定模式自动处理值: userId, userName 或 userId, userName_id, name; 可参考[约定式例子](/components/schema-form#约定式) | `string` |
